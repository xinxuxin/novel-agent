...
const requiredPrompts = [
  ...
  "outline-refine-selected.zh.md",
  "volume-plan-refine.zh.md",
  "chapter-plan-refine.zh.md",
  "material-digest.zh.md",
  "chapter-plan-grid-from-materials.zh.md",
  "chapter-plan-refine-selected.zh.md",
  "chapter-plan-risk-check.zh.md",
  "generate-from-accepted-chapter-plan.zh.md",
  "batch-generation-preflight.zh.md",
  ...
  "selected-text-rewrite.zh.md",
  "chapter-expand-to-target.zh.md",
  "chapter-compress-to-target.zh.md",
  "chapter-rewrite-with-constraints.zh.md",
  "hook-variants.zh.md",
  "ending-variants.zh.md",
  "continuity-audit.zh.md",
  "plan-chat-edit.zh.md",
